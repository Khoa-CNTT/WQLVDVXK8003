        ...
        <div className="container mx-auto flex justify-between items-center px-6">
          ...
          <nav>
            <ul className="flex space-x-8">
              <li>
                <button onClick={handleGoToHome} className="hover:text-orange-200 transition duration-300">
                  Trang Chủ
                </button>
              </li>
            </ul>
      ...
      <section className="container mx-auto p-8 bg-white shadow-xl rounded-2xl my-10">
        ...
        <div className="text-gray-700 leading-relaxed space-y-6">
          ...
          <div className="text-center mt-8">
            ...
            <button onClick={handleGoToHome} className="mt-6 inline-block btn-modern text-white px-6 py-3 rounded-lg">
              Quay lại Trang Chủ
            </button>
          </div>
        </div>
