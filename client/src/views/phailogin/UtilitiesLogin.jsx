...
import './UtilitiesLogin.css';

const UtilitiesLogin = () => {
  const navigate = useNavigate(); // Thêm dòng này
  const [isChatbotOpen, setIsChatbotOpen] = useState(false);
  const [messages, setMessages] = useState([]);

  // Thêm hàm xử lý điều hướng
  const handleGoToHome = (e) => {
    e.preventDefault(); // Ngăn chặn hành vi mặc định của link
    navigate('/home', { replace: true }); // Sử dụng replace để thay thế URL trong lịch sử
  };
  ...
  useEffect(() => {
    ...
    // Thêm đoạn code xóa tham số logout=true khỏi URL
  ...
  return (
    <div className="utilitiesLogin">
        ...
        <div className="container">
          ...
          <nav>
            <ul className="nav-list">
              {/* Thay đổi thẻ a thành button với style để trông giống link */}
              <li>
                <button 
      ...
      {/* Thêm CSS inline cho nav-link-button */}
      <style jsx>{`
        .nav-link-button {
          background: none;
          border: none;
          ...
          <div className="footer-grid">
            ...
            <div>
              ...
              <ul className="footer-links">
                {/* Sửa các link này thành button với hàm điều hướng tương ứng */}
                <li><button onClick={() => navigate('/home')} className="footer-link-button">Giới thiệu</button></li>
                <li><button onClick={() => navigate('/home')} className="footer-link-button">Liên hệ</button></li>
                <li><button className="footer-link-button">Điều khoản sử dụng</button></li>
                <li><button onClick={() => navigate('/securityLogin')} className="footer-link-button">Chính sách bảo mật</button></li>
              </ul>
            </div>
            <div>
